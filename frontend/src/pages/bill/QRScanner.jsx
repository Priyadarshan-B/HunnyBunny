...
const QRScanner = () => {
  ...
  const handleSaveBill = async () => {
    ...
    // const payload = {
    //   customer_name: "Priyan",
    //   total_amount: 145.0,
    //   payment_method: "Cash",
    //   items: [
    //     {
    //       product_name: "Pepper Bread",
    //       quantity: 2,
    //       unit_price: 40.0,
    //     },
    //     {
...
//         { name: "Pepper Bread", quantity: 2, price: 40.0 },
//         { name: "Garlic Bun", quantity: 3, price: 25.0 },
//         { name: "Veg Puff", quantity: 1, price: 30.0 },
//     ];
